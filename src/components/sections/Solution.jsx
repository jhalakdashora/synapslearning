...
const solutions = [
  {
    ...
    points: ['Theory + Practical projects', 'Age-appropriate content', 'Gamified learning modules', 'CBSE/ICSE aligned'],
  ...
  },
  {
    ...
    points: ['IIT/NIT alumni instructors', 'Active industry practitioners', 'Mentorship sessions', 'Live project guidance'],
